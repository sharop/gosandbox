...
// NewLogger Creacion de logger
// Esta funcion no tiene relacion con Fx
...
// NewHandler construye un manejador HTTP simple.
// Fx tratara NeHandler como el constructor para el tipo http.Handler
